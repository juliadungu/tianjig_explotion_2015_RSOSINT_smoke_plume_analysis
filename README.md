...
Immediate event record — 12 August: CIMSS shortwave-infrared satellite sequence.

Later atmospheric aftermath — 13 August: NASA Terra and Aqua MODIS imagery.
...
Himawari-8 / 3.9 µm SWIR

Immediate pre-explosion comparison, four minutes before the recorded explosions
...
First selected Himawari frame after both recorded explosions
...
Later state in the same Himawari sequence
...
Dark smoke plume over the Bohai Sea

N2

13 Aug, about three hours after 02:30 UTC

Aqua / MODIS imagery

Later plume; proxy-centroid displacement is ~40–60 km south-southeast from N1
...
The source animation is preserved in images/himawari/, and the selected frames are extracted reproducibly with scripts/extract_cimss_gif.py.
